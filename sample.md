...
専門職として目指すべき姿は、高度な専門知識を基に組織全体の生産性や競争力を高める存在です。そのために、最新技術や業界標準を継続的に学び、それを誰もが扱えるように一般化する力が求められます。セキュリティ診断分野においては、新しい技術や脆弱性へ迅速に対応し、それらを簡易な手順で実践できる診断手順を構築します。このような取り組みにより、お客様の要望に迅速に対応し、メンバーが効率よく業務を進められる環境を整備します。
少ない人数でより効果的な成果を上げるため、裁量労働を活用しながら業務効率化を進める必要があります。限られたリソースを最大限活用するため、プロセスの自動化やツールの導入を推進し、メンバーが本質的な業務に集中できる環境を整えます。特に、AI技術の利活用が急速に進む中で、UBセキュアが診断事業において検証段階にも至らず、後れを取っている現状は改善すべき課題です。適切な領域で正しい使い方をすれば非常に強力な力を発揮できるツールであり、活用できるかという判断を行うためにも一歩AIという領域に入り込むことが必要です。自動化をはじめとする業務効率化に積極的に取り組み、診断の質とスピードを向上させることで、組織全体の成果を向上させたいと考えています。
さらに、専門職として重要なのはアウトプットを生み出す力です。習得した技術や知識を他のメンバーに共有し、学び成長できる環境を整備します。また、アウトプットの質を向上させるため、プロジェクトの初期段階から深く関与し、目標達成に向けた戦略を練る取り組みに力を入れます。
